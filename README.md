...
A high-performance, resilient insurance submission management system designed to demonstrate modern microservices patterns, concurrent processing, and fault tolerance.
...
*Built with ❤️ for resilient software engineering.*
