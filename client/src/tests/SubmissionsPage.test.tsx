...
import { submissionsApi } from '../store/api'
...
const renderWithProviders = (ui: React.ReactElement) => {
	const store = configureStore({
		...
		middleware: (getDefaultMiddleware) =>
			getDefaultMiddleware({ serializableCheck: false }).concat(submissionsApi.middleware),
	})
...
describe('SubmissionsPage Pagination UI', () => {
	const mockUseGetSubmissionsQuery = useGetSubmissionsQuery as unknown as ReturnType<typeof vi.fn>
